...
# NOTE: summarize_progress and summarize_methods are not currently used.
# They were written for planned inter-agent context injection but the
# orchestrator builds context inline instead.  Kept for potential future use.
