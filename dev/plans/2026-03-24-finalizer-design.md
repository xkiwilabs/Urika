...
1. Should the Finalizer produce a LaTeX-ready report in addition to markdown? (Many researchers need this for journal submission)

2. Should the standalone method scripts include a `requirements.txt` for the specific packages they use?

3. Should the Finalizer create a `reproduce.sh` script that sets up a fresh environment and runs the analysis end-to-end?
